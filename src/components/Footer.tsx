...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/girishnegi",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/girishnegi",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Twitter",
    href: "https://twitter.com/girishnegi",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 px-6 py-16 sm:flex-row">
        ...
        >
          ...
          <span className="text-xs text-muted/60">
            &copy; {new Date().getFullYear()} &middot; Crafted with precision
          </span>
        </motion.div>
        ...
        <div className="flex items-center gap-3">
          {socialLinks.map((link) => (
            <motion.a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-border/30 text-muted transition-all hover:text-foreground hover:border-border/60 hover:bg-surface-light/50"
